...
[![CRATES](https://img.shields.io/crates/v/vertx-http-gateway-rust-connector?label=vertx-http-gateway-rust-connector&logoColor=red)](https://crates.io/crates/vertx-http-gateway-rust-connector)
### How does it work?
